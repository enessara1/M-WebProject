<%@ Page Language="C#" AutoEventWireup="true" CodeFile="investors_presentations.aspx.cs" Inherits="investors_presentations" %>
    ...
    <form id="form1" runat="server">
        ...
        <div id="mobil-header">
            <div class="container">
                <div class="mobil-flex">
                    <div class="left">
                        <a href="index.html">
                            <img src="./images/logo.png" class="white1 logo" /></a>
                        <a href="index.html">
                            <img src="./images/logo2.png" class="black1 logo" /></a>
                        <a href="index.html">
                                        ...
                                        <div class="alt-sol-yan container-fluid-custom" style="color: white; top: 10%; left: 12%;">
                                            <div class="solTarafaltmenu">
                                                <ul class="menuAlt navborder">
                                                    ...
                                                    <li><a href="investors_financialreports.aspx">Financial reports</a></li>
                                                    <li><a class="active" href="investors_presentations.aspx">Presentations</a></li>
        ...
        <section class="consultancy-section" style="background-image: url('./images/ConsultancyNav1.png');">
            ...
            <div class="container container-fluid-custom">
                ...
                <div class="row">
                    <div class="col-md-7">
                        <p class="font-size-45 white-color line-height-1">Presentations</p>
                    </div>
                    <div class="col-md-5">

                        <p class="pageTitleBread">Home/Investors/Presentations...</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section>
            <div class="container-fluid-custom paddingBottom100 paddingTop100">
                <div class="row">
        ...
        <section>
            <div class="container-fluid-custom docs mb-100">
                <ul>
                    <asp:Repeater runat="server" ID="rptPresentation">
                        <ItemTemplate>
